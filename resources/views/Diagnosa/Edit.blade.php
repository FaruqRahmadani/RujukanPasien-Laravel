    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-horizontal" action="{{Route('submitEdit-Diagnosa', ['Id' => HCrypt::Encrypt($Diagnosa->id)])}}" method="post">
            @csrf
            <div class="form-group">
              <label class="col-sm-2 control-label">Kode</label>
              <div class="col-sm-10">
                <input class="form-control" type="text" placeholder="Kode" name="kode" value="{{$Diagnosa->kode}}" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Keterangan</label>
              <div class="col-sm-10">
                <textarea class="form-control" name="keterangan" rows="2" cols="80" required>{{$Diagnosa->keterangan}}</textarea>
              </div>
            </div>
            <div class="form-group">
